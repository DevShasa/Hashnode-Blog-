...
#Numbers saved into a list which is then sorted through bubble sort  
#Initialize the list
unsorted_list = []

#Generate ten random numbers to sort using the random library, the for loop will generate ten random numbers 
...
for out_loop_count in range(0, len(list_to_sort)):
    #Nested for loops allow multiple passes untill list is sorted
